...
public:
  ...
  */
  ...
  int randomTime(int minimo, int maximo) {
	  int variacao = minimo - maximo;
	  srand(time(NULL));
	  return minimo + (rand() % variacao);
  }
